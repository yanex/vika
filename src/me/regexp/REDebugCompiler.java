...
public class REDebugCompiler extends RECompiler {
  ...
  static {
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_RELUCTANTSTAR), "OP_RELUCTANTSTAR");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_RELUCTANTPLUS), "OP_RELUCTANTPLUS");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_RELUCTANTMAYBE), "OP_RELUCTANTMAYBE");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_END), "OP_END");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_BOL), "OP_BOL");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_EOL), "OP_EOL");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_ANY), "OP_ANY");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_ANYOF), "OP_ANYOF");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_BRANCH), "OP_BRANCH");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_ATOM), "OP_ATOM");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_STAR), "OP_STAR");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_PLUS), "OP_PLUS");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_MAYBE), "OP_MAYBE");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_NOTHING), "OP_NOTHING");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_GOTO), "OP_GOTO");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_CONTINUE), "OP_CONTINUE");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_ESCAPE), "OP_ESCAPE");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_OPEN), "OP_OPEN");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_CLOSE), "OP_CLOSE");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_BACKREF), "OP_BACKREF");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_POSIXCLASS), "OP_POSIXCLASS");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_OPEN_CLUSTER), "OP_OPEN_CLUSTER");
    REDebugCompiler.hashOpcode.put(new Integer(RE.OP_CLOSE_CLUSTER), "OP_CLOSE_CLUSTER");
  }
  ...
  String opcodeToString(char opcode) {
    ...
    String ret = (String) REDebugCompiler.hashOpcode.get(new Integer(opcode));
